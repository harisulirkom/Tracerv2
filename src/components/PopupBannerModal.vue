...
<template>
  <Teleport to="body">
    <div
      ...
      @click.self="dismiss"
    >
      <section class="relative flex max-h-[92vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl shadow-slate-950/30">
        <button
          type="button"
        ...
        <div class="flex min-h-0 flex-1 items-center justify-center bg-slate-100">
          <img
            :src="banner.imageUrl"
        ...
        <div class="shrink-0 space-y-3 px-5 py-4 sm:px-6">
          <div>
